...
COPY suppliers (sid,sname,address)

FROM '/home/csmajs/wongc/Desktop/cs166/lab6/stuff/suppliers.txt'

WITH DELIMITER ';';



COPY parts(pid,pname,color)

FROM '/home/csmajs/wongc/Desktop/cs166/lab6/stuff/parts.txt'

WITH DELIMITER ',';



COPY catalog (sid,pid,cost)

FROM '/home/csmajs/wongc/Desktop/cs166/lab6/stuff/catalog.txt'
