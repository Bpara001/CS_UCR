...
GLuint loadShader(const char* vertexfilename, const char* fragmentfilename)
{
	...
	string vertexFile = getTextFile("vertext.cpp");
	string fragmentFile = getTextFile("fragment.cpp");

	//glCreateShader, glShaderSource, glcomplieshader for vertex
	...
	//glCreateShader, glShaderSource, glcomplieshader for fragment
